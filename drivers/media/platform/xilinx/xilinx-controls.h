...
/* spc(dpc) */
#define V4L2_CID_XILINX_SPC			(V4L2_CID_XILINX_BASE + 0x020)
...
/* stats */
#define V4L2_CID_XILINX_STATS			(V4L2_CID_XILINX_BASE + 0x060)
...
/* ccm */
#define V4L2_CID_XILINX_CCM			(V4L2_CID_XILINX_BASE + 0x080)
...
/* enhance */
#define V4L2_CID_XILINX_ENHANCE			(V4L2_CID_XILINX_BASE + 0x0e0)
...
/* cresample */
#define V4L2_CID_XILINX_CRESAMPLE		(V4L2_CID_XILINX_BASE + 0x100)
...
#define V4L2_CID_XILINX_SCALER_HSF		(V4L2_CID_XILINX_SCALER + 1)
#define V4L2_CID_XILINX_SCALER_VSF		(V4L2_CID_XILINX_SCALER + 2)
