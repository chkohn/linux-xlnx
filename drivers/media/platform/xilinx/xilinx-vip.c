...
static const struct xvip_video_format xvip_video_formats[] = {
	{ "rbg", 8, 3, MEDIA_BUS_FMT_RBG888_1X24, 0, NULL },
	{ "xrgb", 8, 4, MEDIA_BUS_FMT_RGB888_1X32_PADHI, V4L2_PIX_FMT_BGR32,
	  "RGB32 (BE)" },
	{ "yuv422", 8, 2, MEDIA_BUS_FMT_UYVY8_1X16, V4L2_PIX_FMT_YUYV,
	  "4:2:2, packed, YUYV" },
	{ "yuv444", 8, 3, MEDIA_BUS_FMT_VUY8_1X24, V4L2_PIX_FMT_YUV444,
	  "4:4:4, packed, YUYV" },
	{ "rggb", 8, 1, MEDIA_BUS_FMT_SRGGB8_1X8, V4L2_PIX_FMT_SGRBG8,
	  "Bayer 8-bit RGGB" },
	{ "grbg", 8, 1, MEDIA_BUS_FMT_SGRBG8_1X8, V4L2_PIX_FMT_SGRBG8,
	  "Bayer 8-bit GRBG" },
	{ "gbrg", 8, 1, MEDIA_BUS_FMT_SGBRG8_1X8, V4L2_PIX_FMT_SGBRG8,
	  "Bayer 8-bit GBRG" },
	{ "bggr", 8, 1, MEDIA_BUS_FMT_SBGGR8_1X8, V4L2_PIX_FMT_SBGGR8,
	  "Bayer 8-bit BGGR" },
};
