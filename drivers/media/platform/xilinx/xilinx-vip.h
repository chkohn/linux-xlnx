...
#define XVIP_OUTPUT_ENCODING			0x0028
#define XVIP_OUTPUT_NBITS_8			(0 << 4)
#define XVIP_OUTPUT_NBITS_10			(1 << 4)
#define XVIP_OUTPUT_NBITS_12			(2 << 4)
#define XVIP_OUTPUT_NBITS_16			(3 << 4)
#define XVIP_OUTPUT_NBITS_MASK			(3 << 4)
#define XVIP_OUTPUT_NBITS_SHIFT			4
#define XVIP_VIDEO_FORMAT_YUV422		(0 << 0)
#define XVIP_VIDEO_FORMAT_YUV444		(1 << 0)
#define XVIP_VIDEO_FORMAT_RGB			(2 << 0)
#define XVIP_VIDEO_FORMAT_YUV420		(3 << 0)
#define XVIP_VIDEO_FORMAT_MASK			(3 << 0)
#define XVIP_VIDEO_FORMAT_SHIFT			0
...
{
	xvip_write(xvip, XVIP_CTRL_CONTROL, XVIP_CTRL_CONTROL_SW_ENABLE |
...
static inline void xvip_set_size(struct xvip_device *xvip, u32 width,
				 u32 height)
{
